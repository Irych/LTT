...
ML =  np.array([ 2.7986162739260899e+03, 0., 9.5950000000000000e+02, 0.,
       2.9851906921878294e+03, 5.3950000000000000e+02, 0., 0., 1. ])

MR = np.array([ 2.8030785191464979e+03, 0., 9.5950000000000000e+02, 0.,
       2.9899504204229311e+03, 5.3950000000000000e+02, 0., 0., 1. ])

DL = np.array([ -3.0195605175804907e-01, 0., 0., 0., 0. ])
DR = np.array([ -2.8760404110746712e-01, 0., 0., 0., 0. ])

img_size = (1920, 1080)
R = np.array([ 9.9993148262771858e-01, -6.8381673743507926e-03,
       -9.5010271493625609e-03, 6.6700706261733685e-03,
       9.9982263176414121e-01, -1.7612926221053014e-02,
       9.6197821063898990e-03, 1.7548346907522713e-02,
       9.9979973760400576e-01 ])
